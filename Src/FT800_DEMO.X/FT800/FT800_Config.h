...
#define DISPLAY_WIDTH    (480U)    // hotizontal resolution
#define DISPLAY_HBP      (41U)     // hotizontal back porch
#define DISPLAY_HFP      (25U)     // hotizontal front porch
#define DISPLAY_HSLEN    (2U)      // hotizontal sync length
