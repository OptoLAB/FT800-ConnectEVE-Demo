...
//interrupt 
void __ISR(_EXTERNAL_3_VECTOR, IPL7SOFT) ExternalInterrupt0(void){
    touched = 1;
    IFS0bits.INT3IF = 0;
}
...
void Init(void)
{
    ...
    DDPCONbits.JTAGEN = 0;
    AD1PCFG = 0xFFFF;
    TRISDbits.TRISD6=0; //DATA LED
    TRISGbits.TRISG6=0; //STAT LED
    ...
    while(1)
    {
        switch(menu)
        {
            ...
            case PRIMITIVES:
                ...
                unsigned short xs[10]={0, 50, 100, 150, 200, 250, 300, 350, 400, 472};
                unsigned short ys[10]={0, 200, 10, 50, 100, 150, 20, 40, 100, 0}; 
